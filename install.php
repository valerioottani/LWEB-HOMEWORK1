...
$dati_brani = [
    ...
    'Sfera Ebbasta' => [
      ...
      'SixTeenReid' => [
        'album' => '', 'anno' => 2020, 'copertina' => 'calmo.png',
        'tracce' => [
            ['Tempo Perso', '3:02', 'tempo_perso.png'],
            ['Piena Estate', '2:50', 'piena_estate.png'],
            ['Calmo', '2:21', 'calmo.png']
        ]
    ],
          'Luca Romeo' => [
        'album' => '', 'anno' => 2020, 'copertina' => 'luca_sfondo.png',
        'tracce' => [
            ['Tempo Perso', '3:02', 'tempo_perso.png'],
            ['Un\'altra scusa', '2:50', 'altra_scusa.png'],
            ['Strega', '2:21', 'strega.png'],
            ['Alice', '3:15', 'alice.png']
        ]
    ],
];
...
<body style="background-color: #121212; color: #ffffff; font-family: Arial, sans-serif; padding: 40px; text-align: center;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #181818; padding: 32px; border-radius: 8px;">
        ...
        <p style="color: #b3b3b3; font-size: 14px; line-height: 1.6;">Database creato e popolato correttamente. Effettua l'accesso per continuare.</p>
